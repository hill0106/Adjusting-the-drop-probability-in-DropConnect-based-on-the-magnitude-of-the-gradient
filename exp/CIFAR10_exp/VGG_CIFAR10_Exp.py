...
import models.VGG_cifar10 as VGG
...
train_set = torchvision.datasets.CIFAR10(root=file_loc, train=True,
                                        download=True)

test_set = torchvision.datasets.CIFAR10(root=file_loc, train=False,
                                       download=True)
